<script setup>
    ...
    const goToPage = (record) => {
        ...
        router.push({ path: '/content', query: { time: record.time, userID: record.user_id, content: record.content, postID: record.post_id } })
    }
</script>
...
<template>
    ...
    <div style=" position: fixed; margin: 0 auto; width: 100%; ">
        <div class="list">
            <el-container class="layout-container-demo" style="height: 700px; border-radius: 4px;">
                <el-container>
                    <el-header style="text-align: right; font-size: 12px">
                        <div class="toolbar">
                            <el-button @click="edit()" style="background: #2e7f78; color: white; background-color: #2e7f78" type="" :icon="Edit" circle />
                        </div>
                    </el-header>

                    <el-main>
                        <el-scrollbar>
                            <el-table @row-click="goToPage"
                                      :data="tableData"
