<script setup>
    ...
    onFetchResponse((response) => {
        ...
        if (data._value.code === 200) {
            ...
            userData.user_type = data._value.data.user_type
            userData.user_id = data._value.data.user_id
    ...
    <div style=" position: fixed; margin: 0 auto; width: 100%; ">
        ...
        <div class="login">
            <div class="body">
                ...
                <el-divider />
                <el-input v-model="inputUserName" style="width: 100%" placeholder="账号" />
                <div style="height:15px"></div>
                <el-input v-model="inputPassword" type="password" style="width: 100%" placeholder="密码" show-password />
                <div style="height:15px"></div>
                <div style="display: flex; justify-content: flex-end;">
                    <el-button @click="execute" style="background:#39c5bb;color:white">提交</el-button>
                </div>
            </div>
        </div>
    </div>
